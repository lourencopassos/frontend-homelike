 ...
 *
 * To run a query within a React component, call `useIssuesListPaginatedQuery` and pass it any options that fit your needs.
 * When your component renders, `useIssuesListPaginatedQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useIssuesListPaginatedQuery({
 *   variables: {
 *      cursor: // value for 'cursor'
 *   },
 * });
 ...
 *
 * To run a query within a React component, call `useIssuesListByStateQuery` and pass it any options that fit your needs.
 * When your component renders, `useIssuesListByStateQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useIssuesListByStateQuery({
 *   variables: {
 *      state: // value for 'state'
 *   },
 * });
